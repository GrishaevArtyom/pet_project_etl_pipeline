...
Реализована двухуровневая архитектура: сырые данные хранятся в MinIO, очищенные данные и витрины — в PostgreSQL. Оркестрация ETL-задач выполняется через Apache Airflow, визуализация — в Metabase.
