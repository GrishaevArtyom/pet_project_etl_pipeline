...
DESCRIPTION = "Ежедневная агрегация данных: подсчёт количества землетрясений за каждый день из оперативного слоя и сохранение результата в витрину данных. DAG запускается после загрузки сырых данных в PostgreSQL."
